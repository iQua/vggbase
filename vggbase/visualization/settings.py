...
INVALID_TEXT = float("inf")


mat_colors_digial_map = {
    "red": 0,
    "blue": 1,
    "green": 2,
    "yellow": 3,
...
# Here is the color for the opencv-based color.
#   There is no reason about why we set red, it plots blue and we set blue, it plot red
#   thus, we switch the two
cv_colors_digial_map = {
    "red": 1,
    "blue": 0,
    "green": 2,
    "yellow": 3,
...
def cv_color_setup(color_name):
    """Convert color_name to cv enable one."""
    return np.array(colors.to_rgb(color_name)) * 255
