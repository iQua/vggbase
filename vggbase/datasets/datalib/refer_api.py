"""
This code snippet was obtained from a publicly 
accessible GitHub repository located at 
...
class REFER:
    def __init__(
        ...
        if dataset in ["refcoco", "refcoco+", "refcocog"]:
            ...
            logging.info("No refer dataset is called [%s]", dataset)
            sys.exit()
        ...
        # create index
        self.createIndex()
        logging.info("DONE (t=%.2fs)", (time.perf_counter() - tic))
